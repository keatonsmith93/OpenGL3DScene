...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	//this callback is used to receive mouse scroll speed
...
// mouse scroll callback that adjusts movement speed
void scroll_callback(GLFWwindow* window, double xOffset, double yOffset)
{
	//Adjust speed based on scroll direction
	g_pCamera->MovementSpeed += yOffset * 1.0f;

	//Clamp to avoid negative or insane speeds
...
void ViewManager::PrepareSceneView()
{
	...
	if (bOrthographicProjection)
	{
		...
		// Orthographic camera looks straight at the object
